...
export class Orchestrator {
     ...
     */
    async createAgent(role, name, mcpServices = {}, customPrompt) {
     ...
     */
    async callAgentMcpTool(agentId, serviceName, toolName, args = {}) {
        const manager = this.mcpManagers.get(agentId);
        if (!manager) {
     ...
     */
    async routeTask(task, targetAgentId) {
